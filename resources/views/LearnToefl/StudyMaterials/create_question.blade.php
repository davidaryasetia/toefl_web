                        ...
                        <div class="question-template">
                            ...
                            <div class="row">
                                <div class="mb-4 col-lg-12">
                                    ...
                                    <textarea type="text" class="form-control" id="pembahasan" name="pembahasan" aria-describedby="emailHelp" rows="3"
                                        placeholder="Input Disccussion....."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
