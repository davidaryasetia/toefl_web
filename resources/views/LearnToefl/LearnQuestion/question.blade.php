            ...
            <div class="card-body p-4 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div class="d-flex align-items-center">
                        <div>
                            <span class="card-title fw-semibold me-3">Data Learn Question</span>
                        </div>
                        <div class="me-3">
                    ...
                    <table id="table_master" class="table table-hover table-bordered text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal text-center"><a href="{{ route('DataSoal.show', ['DataSoal' => $dataSoal['id']]) }}"><i class="ti ti-eye"></i></a>
                                    </p>
                                </td>
                                <td class="border-bottom-0">
