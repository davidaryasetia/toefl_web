        ...
        <div class="card w-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="me-2">
                        <span class="card-title fw-semibold">Add Question To : {{ $data[0]['name'] }} </span>
                    </div>
                    {{-- <button type="button" class="btn rounded-pill btn-outline-primary" id="addQuestion">Add Row</button> --}}
                </div>

                <form action="{{ route('PaketSoal.store_question') }}" method="POST">
                    @csrf

                    <div class="question-fields">
                        <div class="question-template">
                            <input type="hidden" class="form-control" id="packet_id" name="packet_id"
                            ...
                            <div class="row">
                                <div class="mb-4 col-lg-9">
                                    ...
                                    <input type="text" class="form-control" id="answer[]" name="answer[]"
                                        aria-describedby="emailHelp" placeholder="Input Answer 2....." />
                                </div>
                                <div class="mb-4 col-lg-3">
                                    <label for="paket" class="form-label">Is Correct</label>
                                    <div class="">
                            ...
                            <div class="row">
                                <div class="mb-4 col-lg-9">
                                    ...
                                    <input type="text" class="form-control" id="answer[]" name="answer[]"
                                        aria-describedby="emailHelp" placeholder="Input Answer 3....." />
                                </div>
                                <div class="mb-4 col-lg-3">
                                    <label for="paket" class="form-label">Is Correct</label>
                                    <div class="">
                            ...
                            <div class="row">
                                <div class="mb-4 col-lg-9">
                                    ...
                                    <input type="text" class="form-control" id="answer[]" name="answer[]"
                                        aria-describedby="emailHelp" rows="3" placeholder="Input Answer 4....." />
                                </div>
                                <div class="mb-4 col-lg-3">
                                    <label for="paket" class="form-label">Is Correct</label>
                                    <div class="">
