...
@section('row')
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4 shadow-none">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <a href="{{ route('Profile.edit', ['Profile' => $dataUser[0]['id']]) }}" class=""><i
                                    class="ti ti-pencil me-1" style="font-size: 18px"></i><span
                                    style="font-size: 14">Edit</span>
                            </a>
                        </div>
                    </div>
                ...
                <section class="section profile">
                    <div class="row">
                        <div class="col-xl-4 card shadow-none border d-flex flex-column align-items-center justify-content-center">
